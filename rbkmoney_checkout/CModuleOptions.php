...
class CModuleOptions
{
    ...
    public function CModuleOptions($module_id, $arTabs, $arGroups, $arOptions, $need_access_tab = false)
    {
        ...
        if($need_access_tab)
            $this->arTabs[] = array(
                'DIV' => 'edit_access_tab',
                'TAB' => GetMessage("rbkmoney_checkout_SETTINGS_ACESS"),
                'ICON' => '',
                'TITLE' => GetMessage("rbkmoney_checkout_SETTINGS_ACESS_DESC")
            );        
    ...
    public function ShowHTML()
    {
        ...
        if(is_array($this->arOptions))
        {
            ...
            echo     '<input type="hidden" name="update" value="Y" />
                    <input type="submit" class="adm-btn-save" name="save" value="'.GetMessage("rbkmoney_checkout_SETTINGS_SAVE").'" />
                    <input type="reset" name="reset" value="'.GetMessage("rbkmoney_checkout_SETTINGS_CANSEL").'" />
                    </form>';
